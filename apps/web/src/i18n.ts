...
const es = {
  ...
  'share.text': 'Te invito a {name} en Chaggu: {url} (código {code})',
  'share.textNoCode': 'Te invito a {name} en Chaggu: {url}',
  ...
  'fwd.tiecoms': 'A otra conversación de Chaggu…', 'fwd.whatsapp': 'Por WhatsApp', 'fwd.slack': 'Copiar para Slack', 'fwd.email': 'Por correo', 'fwd.teams': 'Copiar para Teams',
  ...
  'src.whatsapp': 'WhatsApp', 'src.slack': 'Slack', 'src.email': 'correo', 'src.teams': 'Teams', 'src.tiecoms': 'Chaggu', 'src.other': 'otra app',
  'imp.action': 'Traer desde WhatsApp, Slack o correo', 'imp.title': 'Traer a Chaggu', 'imp.body': 'Pega lo que copiaste de WhatsApp, Slack, un correo u otra app. Queda marcado con su origen y su autor original.',
  ...
  'share.title': 'Compartir en Chaggu', 'share.body': 'Elige dónde publicar lo que compartiste.', 'share.empty': 'No llegó nada para compartir.',
  // Recordatorios
  ...
  'err.domain_claimed': 'Tu empresa ya está en Chaggu. Pide a su administrador que te invite.',
  ...
  'wa.privacy': 'Solo tú ves estos chats. Chaggu no envía mensajes ni marca nada como leído. Puedes desconectar cuando quieras y se borra todo.',
  ...
  'wa.disconnect': 'Desconectar', 'wa.disconnectConfirm': '¿Desconectar «{label}»? Se cierra la sesión en WhatsApp y se borran de Chaggu sus chats.',
  ...
  'wa.members': '{n} miembros', 'wa.category': 'Categoría', 'wa.manual': 'La elegiste tú', 'wa.suggested': 'Sugerida por Chaggu',
  ...
  'wa.linkTo': 'Traer los mensajes nuevos a una conversación de Chaggu', 'wa.notLinked': 'No vincular',
  ...
  'share.header': 'Compartir en Chaggu', 'share.addMessage': 'Añadir un mensaje…', 'share.send': 'Enviar', 'share.sendTo': 'Enviar a {n}',
  'share.max5': 'Puedes enviar a 5 conversaciones como máximo.', 'share.signIn': 'Inicia sesión en Chaggu para compartir', 'share.openApp': 'Abrir Chaggu',
  ...
  'voice.micPermission': 'Chaggu usa el micrófono para grabar notas de voz que envías en tus conversaciones.', 'voice.unheard': 'Sin escuchar',
...
const en: Record<Key, string> = {
  ...
  'share.share': 'Share…',
  'share.text': 'Join {name} on Chaggu: {url} (code {code})',
  'share.textNoCode': 'Join {name} on Chaggu: {url}',
  ...
  'fwd.tiecoms': 'To another Chaggu conversation…', 'fwd.whatsapp': 'Via WhatsApp', 'fwd.slack': 'Copy for Slack', 'fwd.email': 'Via email', 'fwd.teams': 'Copy for Teams',
  ...
  'src.whatsapp': 'WhatsApp', 'src.slack': 'Slack', 'src.email': 'email', 'src.teams': 'Teams', 'src.tiecoms': 'Chaggu', 'src.other': 'another app',
  'imp.action': 'Bring in from WhatsApp, Slack or email', 'imp.title': 'Bring into Chaggu', 'imp.body': 'Paste what you copied from WhatsApp, Slack, an email or another app. It keeps its source and original author.',
  ...
  'share.title': 'Share to Chaggu', 'share.body': 'Choose where to post what you shared.', 'share.empty': 'Nothing arrived to share.',
  ...
  'err.domain_claimed': 'Your company is already on Chaggu. Ask its administrator to invite you.',
  ...
  'wa.privacy': 'Only you see these chats. Chaggu does not send messages or mark anything as read. Disconnect anytime and everything is deleted.',
  ...
  'wa.disconnect': 'Disconnect', 'wa.disconnectConfirm': 'Disconnect “{label}”? The WhatsApp session is closed and its chats are deleted from Chaggu.',
  ...
  'wa.members': '{n} members', 'wa.category': 'Category', 'wa.manual': 'You picked it', 'wa.suggested': 'Suggested by Chaggu',
  ...
  'wa.linkTo': 'Bring new messages into a Chaggu conversation', 'wa.notLinked': 'Do not link',
  ...
  'share.header': 'Share to Chaggu', 'share.addMessage': 'Add a message…', 'share.send': 'Send', 'share.sendTo': 'Send to {n}',
  'share.max5': 'You can send to up to 5 conversations.', 'share.signIn': 'Sign in to Chaggu to share', 'share.openApp': 'Open Chaggu',
  ...
  'voice.micPermission': 'Chaggu uses the microphone to record the voice notes you send in your conversations.', 'voice.unheard': 'Not played',
