"""Genera la landing estática de www.chaggu.com en dist/: español en / e inglés en /en/.
...
for lang, path, source, title, alt, desc in PAGES:
    es = lang == 'es'
    links = ('<a href="/soporte/">Soporte</a><a href="/eliminar-cuenta/">Eliminar cuenta</a><a href="/privacidad/">Privacidad</a><a href="/terminos/">Términos</a><a href="https://app.chaggu.com/">App</a>' if es
             else '<a href="/en/support/">Support</a><a href="/en/delete-account/">Delete account</a><a href="/en/privacy/">Privacy</a><a href="/en/terms/">Terms</a><a href="https://app.chaggu.com/">App</a>')
    values = {
