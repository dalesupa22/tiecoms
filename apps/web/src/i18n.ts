...
const es = {
  ...
  'dlg.linkOnlyFor': ' y solo sirve para {email}', 'dlg.emailSent': 'Le enviamos la invitación por correo a {email}.', 'dlg.fromCompany': 'Persona de otra empresa', 'dlg.thirdParty': 'Tercero con fecha de salida',
...
const en: Record<Key, string> = {
  ...
  'dlg.linkOnlyFor': ' and only works for {email}', 'dlg.emailSent': 'We emailed the invitation to {email}.', 'dlg.fromCompany': 'Person from another company', 'dlg.thirdParty': 'Guest with an end date',
